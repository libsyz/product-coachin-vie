  ...
  export default {
    ...
    data() {
      return {
        ...
        caseStudies: [
          {id:1,
           imgUrl: "https://images.pexels.com/photos/2173508/pexels-photo-2173508.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
           blurb: 'We kick off the day with high-energy activities that engage our participants and involve them into hands-on activities from the very beggining.',
           title: "setting the scene"},
          {id:2,
           imgUrl: "https://images.pexels.com/photos/1346197/pexels-photo-1346197.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
           blurb: 'Our approach to teaching product management concepts is experiential. Through active discussion, we build on real life examples, relevant case studies.',
