  ...
  export default {
    ...
    data() {
      return {
        ...
        items: [
          {id:1, name: 'Kin Khao', tag: ["Thai"]},
          {id:2, name: 'Jū-Ni', tag: ["Sushi", "Japanese", "$$$$"]},
          {id:3, name: 'Delfina', tag: ["Pizza", "Casual"]},
          {id:4, name: 'San Tung', tag: ["Chinese", "$$"]},
          {id:5, name: 'Anchor Oyster Bar', tag: ["Seafood", "Cioppino"]},
          {id:6, name: 'Locanda', tag: ["Italian"]},
          {id:7, name: 'Garden Creamery', tag: ["Ice cream"]},
        ]
      }
    },
    computed: {
